...
<?php $form=$this->beginWidget('BActiveForm', array(
	...
	<div class="clearfix">
		...
		<div class="input">
			...
			<?php $this->widget('ext.custom.widgets.EJuiAutoCompleteFkField', array(
					      ...
					      'sourceUrl'=>Yii::app()->createUrl('responsable/autocompletesearch'), 
					      'showFKField'=>false,
	...
	<div class="clearfix">
		<?php echo $form->label($model,'planeacion_did'); ?>
		<div class="input">
			
			<?php echo $form->dropDownList($model,planeacion_did,CHtml::listData(Planeacion::model()->findAll(), 'id', 'nombre')); ?>		</div>
	</div>
