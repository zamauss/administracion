...
<?php $form=$this->beginWidget('BActiveForm', array(
	...
	<div class="<?php echo $form->fieldClass($model, 'numero'); ?>">
		...
		<div class="input-prepend">
			...
			<?php echo $form->textField($model,'numero',array('size'=>7,'maxlength'=>7)); ?>
	...
	<div class="well">
		<h3>Seleccione las estrategias del objetivo general</h3>
		<div class="row">	
			<div class="span12">	
				<table>		
			<?php		        
		        echo CHtml::checkBoxList('estrategias',array(),
		        		CHtml::listData(EstrategiaObjetivogeneral::model()->with('estrategia')->findAll(array('condition' => 'objetivoGeneral_did = ' . $_GET['objetivoGeneral_did'],'order'=>'estrategia.id ASC')),'estrategia_did','estrategia.descripcion'),
