...
class DepartamentoController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index','view','create','update','admin','delete','dashboardpordepto'),
				'users'=>array('@'),
			),
			/*
	...
	public function actionAutocompletesearch()
	{
	    ...
	    if (!empty($q))
	    {
			...
			$criteria->limit='10';
	       	$cursor = Departamento::model()->findAll($criteria);
	...
	public function actionDashboardpordepto()
	{		
		$this->render('dashboardpordepto');
	}
}
