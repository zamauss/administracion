...
class PersonaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index','view','create','update','admin','delete','listar','dashboardporcolaborador'),
				'users'=>array('@'),
			),
			/*
	...
	{
		$model=Persona::model()->findByPk((int)$id);
		if($model===null)
	...
	public function actionDashboardporcolaborador()
	{		
		$this->render('dashboardporcolaborador');
	}
}
