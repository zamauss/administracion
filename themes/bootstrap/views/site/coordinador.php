...
<div class="tabbable"> <!-- Pestañas generales de Planeaciones y Activos -->
	  ...
	  <div class="tab-content">
		  <div class="tab-pane active" id="tab1">
		      ...
		      <div class="accordion" id="accordion2">
			      <?php       		
				      $planeaciones = Planeacion::model()->findAll('persona_aid = ' . $persona->id);      		
				      $contador = 0;
							    ...
							    <div id="collapse<?php echo $contador; ?>" class="accordion-body collapse in">
								    <div class="accordion-inner" >
									    <?php
										    ...
										    echo CHtml::button('Nuevo objetivo general', array('submit' => array('objetivoGeneral/create', 'planeacion_did' => $planeacion->id), 'class'=>'btn btn-success btn-large'));
										?>
											<br/><br/>
																		...
																		?>
																  		<div class="btn-group">
																			...
																			<ul class="dropdown-menu">							
																				...
																				<li>
																					<?php
																						echo CHtml::link('<i class="icon-repeat"></i> Actualizar', array('objetivoGeneral/update','id'=>$objGral->id));
																					?>
																				</li>
																				<li class="divider"></li>
																				<li>																	
																					<?php 
																						if($objGral->estatus_did == 1)
																							echo CHtml::link('<i class="icon-trash"></i> Quitar', array('objetivoGeneral/cambiarestatus', 'id'=>$objGral->id)); 
																						else
																							echo CHtml::link('<i class="icon-remove"></i> No la hice', 
																											array('objetivoGeneral/cambiarestatus', 'id'=>$objGral->id)); 
																					?>
																				</li>																
																			</ul>
																		</div>
																	</h3>																	
																</div><? /* Se cierra el Well */ ?>
														         				...
														         				<tbody>
															         				<?php foreach($objetivosPendientes as $objetivo){ ?>
															         						<tr>
																         						<td style="width:20px;">
																	         						<div class="btn-group">
																			         					...
																			         					<ul class="dropdown-menu">							
																					         				...
																					         				<li>
																						         				<?php echo CHtml::link('<i class="icon-repeat"></i> Actualizar', array('objetivo/update','id'=>$objetivo->id, 'objetivoGeneral_did'=>$objetivo->objetivoGeneral_did)); ?>
																							         		</li>
																							         		<li>
																								...
																								<td class="hidden-phone">
																									<?php 
																										if($objetivo->plazo->nombre != 'Ninguno') 
																								...
																								<td style="font-size:9pt;">
																									<?php 
																										...
																										$resumenNota = '';
																									?>	
																									<div id="nota-<?php echo $objetivo->id; ?>" class="modal hide fade in" style="display: none; ">  
																	         					...
																	         					<td class="hidden-phone">
																	         						<?php 
																	         							if($objetivo->estatus->nombre == 'Activo')
						  ...
						  <div class="accordion-group">
						    <div class="accordion-heading">					    	
						      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOE<?php echo $contador;?>">
						        <span class="badge badge-warning"><?php echo count($objetivosExternos); ?></span>
